    ...
    <div class="section-body">
        <div class="card">
            <div class="card-header">
                <h4>Tambah Data Akun Master Akun</h4>
                <a href="<?= site_url('master/akun/index') ?>" class="btn btn-primary ml-auto">Back</a>
            </div>
            <div class="card-body p-4">
                <form method="post" action="<?= site_url('master/akun/index') ?>">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        <label>NO AKUN</label>
                        <input type="text" class="form-control" name="no_akun" placeholder="No Akun" required>
                    </div>
                    <div class="form-group">
