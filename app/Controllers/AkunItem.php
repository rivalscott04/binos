...
class AkunItem extends ResourceController
{
    protected $db;
    private $objItem;
    private $objAkun;
    ...
    function __construct()
    {
        ...
        $this->objItem = new ModelAkunItem();
    ...
    {
        $data['dtakun_item'] = $this->objItem->AmbilRelasi();
    ...
    public function new()
    {
        ...
        $query = $builder->get();
        $data['dtakun_akun'] = $this->objAkun->findAll();
        ...
        return view('master/item/new', $data);
    }
    ...
    public function create()
    {
        ...
        $data = [
            'no_item' => $this->request->getVar('no_item'),
        ...
        $this->db->table('akun_item')->insert($data);
        return redirect()->to(site_url('/master/item/index'))->with('success', 'Data Berhasil Disimpan');
    }
    ...
    public function edit($id = null)
    {
        ...
        $akunakun = $this->objAkun->findAll($id);
        $akunitem = $this->objItem->find($id);

        if (is_object($akunitem)) {
            $data['dtakun_item'] = $akunitem;
    ...
    public function update($id = null)
    {
        ...
        $this->db->table('akun_item')->where(['id_item' => $id])->update($data);
        return redirect()->to(site_url('/master/item/index'))->with('success', 'Data Berhasil Disimpan');
    }
    ...
    {
        $this->db->table('akun_item')->where(['id_item' => $id])->delete();
        return redirect()->to(site_url('master/item/index'))->with('success', 'Data Berhasil Dihapus');
    }
}
